...
- 사용자는 로그인 후 기본 개인 가계부에서 거래를 기록할 수 있습니다.
- 사용자는 두 사람이 쓰는 공동 가계부를 만들고 30분 링크로 상대방을 초대할 수 있습니다.
- 사용자는 예산 기간별 전체·멤버별·공동·카테고리 예산을 운영할 수 있습니다.
- 사용자는 공동 예산과 본인 예산의 사용 가능액을 우선 확인할 수 있습니다.
- 사용자는 빠른 입력과 이미지 일괄 가져오기로 여러 거래를 적은 단계로 기록할 수 있습니다.
- 사용자는 개인 거래가 보이는 범위를 유지하면서 공동 예산과 소비 흐름을 함께 관리할 수 있습니다.
