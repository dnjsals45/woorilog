...
export type BudgetPeriodDetail = BudgetPeriod & { categoryBudgets: Array<{ source: BudgetSource; groupCode: string; groupName: string; amount: number; spentAmount: number }> }
