...
우리로그 프론트엔드 작업 지침입니다. 루트 [`../CLAUDE.md`](../CLAUDE.md)의 일반 원칙을 함께 따릅니다.
프론트엔드 작업 원칙은 이 문서가 기준이며, [`AGENTS.md`](./AGENTS.md)는 이 문서를 가리키는 포인터입니다.
...
UI/화면 변경은 [`../.agent/workflows/ui-qa-playwright.md`](../.agent/workflows/ui-qa-playwright.md)의 QA 체크리스트를 따르고,
